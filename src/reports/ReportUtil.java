...
public class ReportUtil {
	...
	public static String Testcaselink;
	...
	public static void startTesting(String filename,String testStartTime,String env,String rel)
	  {
        ...
        String RUN_DATE = TestUtil.now("dd/MM/yyyy").toString();
	   ...
	   //  out.newLine();
	           ...
	           out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>"+env+"</b></td>\n");
	     out.write("</tr>\n");
	     out.write("<tr>\n");
	     ...
	     out.write("<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>User Name</b></td>\n");
         out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>"+System.getProperty("user.name")+"</b></td>\n");
   out.write("</tr>\n");
   
   out.write("<td width=150 align= left  bgcolor=#153E7E><FONT COLOR=#E0E0E0 FACE= Arial  SIZE=2.75><b>Machine Name</b></td>\n");
   out.write("<td width=150 align= left ><FONT COLOR=#153E7E FACE= Arial  SIZE=2.75><b>"+InetAddress.getLocalHost().getHostName()+"</b></td>\n");
out.write("</tr>\n");
